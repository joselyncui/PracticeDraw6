    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                switch (value) {
                    case 0:
                        imageView.animate().scaleX(1.5f).setDuration(300).start();
                        break;
                    case 1:
                        imageView.animate().scaleX(1).setDuration(300).start();
                        break;
                    case 2:
                        imageView.animate().scaleY(0.5f).setDuration(300).start();
                        break;
                    case 3:
                        imageView.animate().scaleY(1).setDuration(300).start();
                        break;
                }
                index ++;
